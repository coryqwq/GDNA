...
public class DialogueManager : MonoBehaviour
{
    ...
    public void DisplayNextSentence()
    {
        ...
        {
            if(!gameStateScript.levelComplete)
            {
                EndDialogue();
                index = 0;
                return;
            ...
            else
            {
                ...
                SceneTransition sceneTransitionScript = sceneTransition.GetComponent<SceneTransition>();
                sceneTransitionScript.EndTitleMenu();
    ...
    void EndDialogue()
    {
        gameStateScript.levelDialogue = false;
